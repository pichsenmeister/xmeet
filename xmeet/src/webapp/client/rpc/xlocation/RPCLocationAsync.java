...
public interface RPCLocationAsync {
	 ...
	 */
	public void saveXLocation(XLocation location,
			AsyncCallback<XLocation> callback);
	 ...
	 *            a new instance of AsyncCallback<T>
	 */
	public void saveXLocationEntry(XLocationEntry location, XUser owner,
			AsyncCallback<XLocationEntry> callback);
	 ...
	 *            a new instance of AsyncCallback<T>
	 */
	public void searchLocations(String location, int start, int maxResult,
			AsyncCallback<List<XLocation>> callback);
	 ...
	 *            a new instance of AsyncCallback<T>
	 */
	public void loadLocationEntries(XUser user, int start, int maxResult,
			AsyncCallback<List<XLocationEntry>> callback);
