 ...
 */
public class FooterWidget extends ViewImpl implements
		FooterPresenterWidget.IView {

	public static final String ABOUTUS = "about";
	public static final String IMPRINT = "other";
	public static final String RESOURCES = "resources";
	public static final String HELP = "help";
	public static final String TERMS = "tos";
